...
//
    ...
    /*!
     Constructor
    */
    function teamspeakDisplayClass()
    {
        $this->Operators = array( 'TeamspeakUTF8Output',
        			                    'displayTeamspeakEx', );
    }
    ...
    */
    ...
    {
        return array( 'TeamspeakUTF8Output'   => array( 'streamstring' => array( 'type' => 'string',
                                                                                 'required' => true,
                                                                                 'default' => '' )),
                      
                      'displayTeamspeakEx' => array( 'settings' => array( 'type' => 'array',
                                                                          'required' => true,
                                                                          'default' => array() )));
    }
    ...
    */
                     ...
                     &$currentNamespace, &$operatorValue, &$namedParameters )
    {
        switch ( $operatorName )
        {
            case 'TeamspeakUTF8Output':
            {
                $operatorValue = $this->outputtoutf( $namedParameters['streamstring'] );
            } 
            break;
            
            case 'displayTeamspeakEx':
            {
                //$operatorValue = $this->displayTeamspeakEx( $namedParameters['settings'] );
                $operatorValue = $this->queryTeamspeakServerEx( $namedParameters['settings'] );
                $this->sortServerInfo($operatorValue);
            } 
            break;
    	}
    }
    
  function outputtoutf($streamstring) {
		$myresult=utf8_encode($streamstring);
		return $myresult;
	}
